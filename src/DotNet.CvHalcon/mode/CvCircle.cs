...
namespace DotNet.CvHalcon
{
    ...
    public sealed record CvCircle : ICvShape, ICvTransformable<CvCircle>, ICvContainable
    {
        ...
        /// 圆心
        /// </summary>
        public CvPoint Center { get; init; }
        ...
        /// 构造圆弧
        /// </summary>
        public CvCircle(CvPoint center, double radius, double startPhi, double endPhi)
        {
            if (radius < 0) throw new ArgumentOutOfRangeException(nameof(radius), "Radius must be non-negative.");
            Center = center;
            Radius = radius;
        ...
        /// </summary>
        public CvCircle(CvPoint centerPoint, CvPoint edgePoint)
        {
            Center = centerPoint;
        ...
        /// 从三点构造圆（三点确定一个圆）
        /// </summary>
        public static CvCircle? FromThreePoints(CvPoint p1, CvPoint p2, CvPoint p3)
        {
            // 计算两条垂直平分线的交点
        ...
        /// 判断点是否在圆周上（带容差）
        /// </summary>
        public bool IsOnCircumference(CvPoint point, double tolerance = 0.01)
        {
            double distance = Center.DistanceTo(point);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public CvCircle Translate(CvPoint offset)
        {
        ...
        /// 绕指定点旋转
        /// </summary>
        public CvCircle RotateAround(double angle, CvPoint pivot)
        {
            return new CvCircle(
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public CvPoint PointAtAngle(double phi)
        {
            return new CvPoint(
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public double AngleOfPoint(CvPoint point)
        {
        ...
        public CvPoint[] SamplePoints(int count)
        {
            if (count <= 0)
                throw new ArgumentOutOfRangeException(nameof(count), "Count must be positive.");

            var points = new CvPoint[count];
        ...
        /// 单位圆
        /// </summary>
        public static readonly CvCircle Unit = new(CvPoint.Zero, 1);
