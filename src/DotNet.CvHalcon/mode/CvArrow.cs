...
namespace DotNet.CvHalcon
{
    ...
    public sealed record CvArrow : ICvShape, ICvTransformable<CvArrow>
    {
        ...
        /// 起点
        /// </summary>
        public CvPoint Start => Line.Start;

        /// <summary>
        /// 终点
        /// </summary>
        public CvPoint End => Line.End;
        ...
        /// 中点
        /// </summary>
        public CvPoint MidPoint => Line.MidPoint;
        ...
        /// 方向向量
        /// </summary>
        public CvPoint Direction => Line.Direction;

        /// <summary>
        /// 单位方向向量
        /// </summary>
        public CvPoint UnitDirection => Line.UnitDirection;
        ...
        public CvRegion BoundingBox
        {
            ...
            {
                // 计算包含箭头头部的边界框
                GetHeadPoints(out CvPoint left, out CvPoint right);
        ...
        /// 从两点构造箭头
        /// </summary>
        public CvArrow(CvPoint start, CvPoint end, double headSize = 10.0, double headAngle = 30.0)
        {
        ...
        /// 从起点、角度和长度构造箭头
        /// </summary>
        public static CvArrow FromAngle(CvPoint start, double angle, double length, double headSize = 10.0, double headAngle = 30.0)
        {
        ...
        /// 从中点、角度和长度构造箭头
        /// </summary>
        public static CvArrow FromCenterAngle(CvPoint center, double angle, double length, double headSize = 10.0, double headAngle = 30.0)
        {
        ...
        public void GetHeadPoints(out CvPoint left, out CvPoint right)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public CvArrow Translate(CvPoint offset)
        {
        ...
        /// 绕指定点旋转
        /// </summary>
        public CvArrow RotateAround(double angle, CvPoint pivot)
        {
