...
namespace DotNet.CvHalcon
{
    ...
    public sealed record CvFont
    {
        ...
        /// 从点位置构造
        /// </summary>
        public CvFont(CvPoint position, int size = 15)
        {
            ValidateSize(size);
            X = (int)position.X;
            Y = (int)position.Y;
        ...
        /// 从点位置和文本构造
        /// </summary>
        public CvFont(CvPoint position, string text, int size = 15)
        {
            ValidateSize(size);
            X = (int)position.X;
            Y = (int)position.Y;
        ...
        /// 创建带位置和文本的字体
        /// </summary>
        public static CvFont At(CvPoint position, string? text = null, int size = 15)
        {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public CvFont AtPosition(CvPoint position) => this with { X = (int)position.X, Y = (int)position.Y };
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public CvFont WithPosition(CvPoint position) => AtPosition(position);
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public CvFont Translate(CvPoint offset) => Translate((int)offset.X, (int)offset.Y);
