...
namespace OpenCvSharp
{
    ...
    /// <returns></returns>
        ...
        public static Point2f operator +(Point2f pt)
        {
            if (pt == null)
            {
                throw new ArgumentNullException(nameof(pt), "Operand must not be null");
            }
            return pt;
        }
    ...
    /// <returns></returns>
        ...
        public static Point2f operator -(Point2f p1, Point2f p2)
        {
            if (p1 == null)
            {
                throw new ArgumentNullException(nameof(p1), "Left operand must not be null");
            }

            if (p2 == null)
            {
                throw new ArgumentNullException(nameof(p2), "Right operand must not be null");
            }
            return new Point2f(p1.X - p2.X, p1.Y - p2.Y);
        }
