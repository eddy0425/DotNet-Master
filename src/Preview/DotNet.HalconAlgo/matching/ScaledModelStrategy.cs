    ...
    public class ScaledModelStrategy : ParaStrategyBase<ScaledModel>
    {
        ...
        public override bool Fun_action(IHDisplay display, List<IParaStrategy> strategys)
        {
            ...
            try
            {
                ...
                for (int j = 0; j < ho_Rect.CountObj(); j++)
                {
                    ...
                    //查找模板
                    HOperatorSet.FindScaledShapeModel(imgReduced, inPara.ModelID, inPara.AngleStart.TupleRad(), inPara.AngleExtent.TupleRad(),
                                       inPara.ScaleMin, inPara.ScaleMax, inPara.MinScore, inPara.NumMatches,
        ...
        public override void SetTemplate(HDisplayUI display, RectEnum type, bool newModel)
        {
            ...
            try
            {
                ...
                //制作模板
                HOperatorSet.CreateScaledShapeModel(imgReduced, inPara.NumLevels, inPara.AngleStart.TupleRad(), inPara.AngleExtent.TupleRad(), "auto", inPara.ScaleMin, inPara.ScaleMax,
                ...
                HOperatorSet.FindScaledShapeModel(imgReduced, inPara.ModelID, inPara.AngleStart.TupleRad(), inPara.AngleExtent.TupleRad(),
                                            inPara.ScaleMin, inPara.ScaleMax, inPara.MinScore, 1,
                                            inPara.MaxOverlap, inPara.SubPixel, inPara.NumLevels, inPara.Greediness,
                                            out HTuple row, out HTuple column, out HTuple angle, out HTuple scale, out HTuple score);
