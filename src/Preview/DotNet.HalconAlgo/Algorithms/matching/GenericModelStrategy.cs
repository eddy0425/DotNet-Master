...
//                        HOperatorSet.GetGenericShapeModelResultObject(out inPara.HoContour, matchResultID, "all", "contours");
...
//            HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "angle_start", inPara.AngleStart);
//            HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "angle_end", inPara.AngleEnd);
...
//            HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "num_levels", inPara.NumLevels);

//            HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "iso_scale_max", inPara.ScaleMax);
//            HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "iso_scale_min", inPara.ScaleMin);
...
//                //HOperatorSet.SetGenericShapeModelParam(modelID, "angle_start", inPara.AngleStart.TupleRad());
//                //HOperatorSet.SetGenericShapeModelParam(modelID, "angle_end", inPara.AngleEnd.TupleRad());
...
//                HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "num_matches", 1);
//                HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "min_score", inPara.MinScore);
//                HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "num_levels", inPara.NumLevels);
...
//                HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "optimization", "auto");
//                HOperatorSet.SetGenericShapeModelParam(inPara.ModelID, "subpixel", "true");
...
//                HOperatorSet.GetGenericShapeModelResultObject(out ho_Contour, matchResultID, "all", "contours");
