...
//    /// 用于绘制和编辑合成区域
//    /// </summary>
//    public class SynthethicHandler : IDrawHandler
//    {
...
//                ShrContour = DrawSynthethic(display, out RegTopLeft, out RegBottomRight);
//                display.DispRegion(ShrContour, HColor.Green);
...
//                {
//                    // 右键完成编辑
//                    display.DrawSynthethicn(ShrContour, RegTopLeft, RegBottomRight);
...
//                                ShrContour = newTopLeftSynthethic(display, new Point2d(e.X, e.Y), out scaling);
//                                break;
//                            case CycleMoveEnum.EndMove:
//                                RegBottomRight = new Point2d(e.X, e.Y);
//                                ShrContour = newBottomRightSynthethic(display, new Point2d(e.X, e.Y), out scaling);
//                                break;
//                            case CycleMoveEnum.CenterMove:
//                                {
...
//                                    ShrContour = newCenterSynthethic(display, RegCenter, out scaling);
//                                }
//                                break;
//                            default:
//                                {
...
//                        // 显示模型相关区域
//                        display.DispRegion(ShrRegion, HColor.Blue);
//                        display.DispRegion(ShrContour, HColor.Green);

//                        if (ShrCenter != null)
//                        {
//                            display.DispPoint(ShrCenter, HColor.Yellow);
//                        }
//                    }
//                    break;
//            }
...
//                if (ShrCenter != null)
//                {
//                    centerRow = ShrCenter.Y;
//                    centerCol = ShrCenter.X;
//                }
//                else
//                {
//                    // 获取源图像尺寸
