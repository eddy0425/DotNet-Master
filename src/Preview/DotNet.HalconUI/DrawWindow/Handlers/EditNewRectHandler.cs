...
namespace DotNet.HalconUI
{
    ...
    /// 用于绘制和编辑矩形区域
    /// </summary>
    public class EditNewRectHandler : IDrawHandler
    {
        ...
        private void UpdateHoverState(DisplayUI display, HMouseEventArgs e)
        {
        ...
        private static void DispRectangle(DisplayUI display, double x1, double y1, double x2, double y2, string color = "red")
        {
            try
            {
